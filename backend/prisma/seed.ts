    ...
    data: [
      {
        ...
        imageUrl: '...',
        buttonText: 'Mua ngay',
        buttonLink: '/products/nike-air-max-270',
        productId: airMax.id,
        collection: 'Nike',
        order: 1,
        description: 'Khám phá bộ sưu tập Nike Air Max.',
      },
      {
        title: 'Adidas Ultraboost',
        subtitle: 'Thoải mái trên mọi cung đường',
        imageUrl: '...',
        buttonText: 'Khám phá',
        buttonLink: '/products/adidas-ultraboost-22',
        productId: ultraboost.id,
        collection: 'Adidas',
        order: 2,
        description: 'Dòng chạy bộ nổi tiếng.',
      },
      {
        title: 'Converse Classic',
        subtitle: 'Biểu tượng vượt thời gian',
        imageUrl: '...',
        buttonText: 'Xem ngay',
        buttonLink: '/products/converse-chuck-taylor-all-star',
        productId: chuckTaylor.id,
        collection: 'Converse',
        order: 3,
